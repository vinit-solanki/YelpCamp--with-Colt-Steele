...
class be {
  ...
  static fromString(e) {
    return e ? new be({ name: e, available: !1 }) : null;
  }
}
class ee {
  constructor(e, t, n) {
...
class te {
  ...
  static parse(e, t) {
    ...
    if (o === "array") {
      ...
      if (e.length > 2) {
        const u = e[1];
        if (typeof u != "string" || !(u in nt) || u === "object")
...
class kt {
  ...
  concat(e, t, n) {
    ...
    return new kt(this.registry, this._isConstant, a, t || null, o, this.errors);
  }
  /**
...
class Ct {
  ...
  static parse(e, t) {
    ...
    const n = e[1];
    return t.scope.has(n) ? new Ct(n, t.scope.get(n)) : t.error(`Unknown variable "${n}". Make sure "${n}" has been bound in an enclosing "let" expression before using it.`, 1);
  }
  evaluate(e) {
...
class ct {
  ...
  static parse(e, t) {
    ...
    if (e.length === 4) {
      const o = t.parse(e[3], 3, g);
      return o ? new ct(n.type, n, a, o) : null;
    } else
      return new ct(n.type, n, a);
  }
  evaluate(e) {
    const t = this.input.evaluate(e), n = this.beginIndex.evaluate(e);
    let a;
    if (this.endIndex && (a = this.endIndex.evaluate(e)), Le(t, ["string"]))
...
class se {
  ...
  static parse(e, t) {
    ...
    return !ze(l, g) && !ze(l, vt) && !ze(l, ie) && !ze(l, St) && !ze(l, xt) && !ze(l, W(g)) ? t.error(`Type ${N(l)} is not interpolatable.`) : new se(l, n, a, o, s);
  }
  evaluate(e) {
    const t = this.labels, n = this.outputs;
    if (t.length === 1)
...
class Ke {
  ...
  evaluate(e) {
    ...
    for (const o of this.args)
      if (n++, t = o.evaluate(e), t && t instanceof be && !t.available && (a || (a = t.name), t = null, n === this.args.length && (t = a)), t !== null)
        break;
    return t;
  }
  eachChild(e) {
...
function cs(r, e, t) {
  ...
  for (const a of e) {
    ...
    if (o !== i && (n = Math.min(n, ke(r, [i, o], t)), n === 0))
      return n;
    ...
    if (pt(u) <= p && pt(c) <= m) {
      ...
      if (e && n)
        ...
        for (let y = c[0]; y <= c[1]; ++y)
          if (f = ke(t[y], d, a), i = Math.min(i, f), i === 0)
            return i;
      } else if (!e && n) {
...
function ds(r, e) {
  ...
  for (const i of e) {
    switch (i.type) {
      case "Point":
        o = Math.min(o, dt(n, !1, [i.coordinates], !1, a, o));
        break;
      case "LineString":
        o = Math.min(o, dt(n, !1, i.coordinates, !0, a, o));
        break;
      case "Polygon":
        o = Math.min(o, ft(n, !1, i.coordinates, a, o));
        break;
    }
    if (o === 0)
      return o;
...
function ys(r, e) {
  ...
  for (const i of e) {
    switch (i.type) {
      case "Point":
        o = Math.min(o, dt(n, !0, [i.coordinates], !1, a, o));
        break;
      case "LineString":
        o = Math.min(o, dt(n, !0, i.coordinates, !0, a, o));
        break;
      case "Polygon":
        o = Math.min(o, ft(n, !0, i.coordinates, a, o));
        break;
    }
    if (o === 0)
      return o;
...
function ms(r, e) {
  ...
  for (const i of e)
    for (const s of n) {
      switch (i.type) {
        case "Point":
          o = Math.min(o, ft([i.coordinates], !1, s, a, o));
          break;
        case "LineString":
...
function Et(r) {
  ...
  if (r instanceof Ce || r instanceof Ae)
    return !1;
  let e = !0;
...
function Zn(r, e) {
  ...
  let p;
  if (z(i) === "string" && mt(c) && !c.tokens && (p = /^{([^}]+)}$/.exec(i)))
...
class Ns extends wo {
  constructor(t = {}) {
    ...
    L(this, "_rotateCompassArrow", () => {
      ...
      )}) rotateX(${Math.min(70, n)}deg) rotateZ(${-t}deg)` : `rotate(${-t}deg)`;
...
function st(r) {
  ...
  if (k(r, "MultiGeometry") !== null)
    return st(k(r, "MultiGeometry"));
  if (k(r, "MultiTrack") !== null)
    return st(k(r, "MultiTrack"));
...
function ll(r, e) {
  ...
  if (a) {
    ...
    if (e.property && Array.isArray(e.pointColor)) {
      const we = Array.from({ length: o }, (De, et) => {
